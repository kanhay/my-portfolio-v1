...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "acfa9842-d19a-4eff-a8c2-93530f8631e0");
  ...
  return (
    ...
    id='contact' className='w-full bg-cover px-[12%] py-10 scroll-mt-20
    bg-[url("/footer-bgColor.png")] bg-no-repeat bg-center bg-[length:90%_auto]'>
        ...
        transition={{delay:0.9, duration: 0.5}}
         onSubmit={onSubmit} className='max-w-2xl mx-auto' >
            ...
            >Submit now <Image alt="" src={assets.right_arrow_white}
