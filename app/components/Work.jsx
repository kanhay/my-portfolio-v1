...
const Work = () => {
    const displayWork = () => {
        return workData.map(({ title, description, bgImage }, key) => (
            <motion.div
            initial={{opacity: 0}}
            ...
            className="h-64 sm:h-72 bg-no-repeat bg-cover bg-center rounded-lg
  ...
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        >Welcome to my web develomotion.ment portfolio! Expore a collection of projects
        ...
        my-20 hover:bg-[#fcf4ff] duration-500'>See more <Image src={assets.right_arrow_bold} alt='Right arrow' className='w-4' /></motion.a>
    </motion.div>
  )
}
